...
export const ProfessionalCertificate: React.FC<ProfessionalCertificateProps> = ({
  ...
  return (
    <div className={`flex flex-col items-center gap-6 ${className}`}>
      {/* Certificate Container - 3:2 Aspect Ratio (Standard Landscape) */}
      <div 
        ref={certificateRef}
        className="relative w-full max-w-[800px] aspect-[1.414/1] bg-white shadow-2xl rounded-sm overflow-hidden select-none border border-border/50"
        style={{
