...
export const Insights = () => {
  ...
  const insights = [
    { 
      icon: TrendingUp, 
      title: "Strong Growth", 
      description: "You've added 5 new skills this month", 
      color: "text-accent" 
    },
    { 
      icon: Target, 
      title: "Frontend Focus", 
      description: "Your strongest area is Frontend development", 
      color: "text-primary" 
    },
    { 
      icon: Zap, 
      title: "Quick Learner", 
      description: "Average of 2.3 hours per skill mastered", 
      color: "text-warning" 
    },
    { 
      icon: Award, 
  ...
  const completedRoadmapItems = roadmap.filter(r => r.completed).length;
  const totalLearningHours = skillGrowthData.reduce((acc, d) => acc + d.hours, 0);
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Strength vs Weakness</CardTitle>
              <CardDescription>Your skill distribution by category</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Summary of your learning journey this month</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="space-y-2">
                <h4 className="font-medium">Top Achievements</h4>
